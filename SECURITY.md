...
This policy applies to **`Kenearos/bmad-doc-ai-agent`**. It is derived from our engineering
...
1. Email **kenearos@googlemail.com** with the subject prefix `[SECURITY] bmad-doc-ai-agent`.
...
| Version | Supported |
|---------|-----------|
| Latest release of `bmad-doc-ai-agent` | ✅ Yes |
